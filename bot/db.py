...
def add_position(conn, name_katalog: str, name: str, description: str, price, item: str, lot):
    ...
    c.execute("INSERT INTO position (name_katalog, name, description, price, item, lot) VALUES (?, ?, ?, ?, ?, ?)",
              (name_katalog, name, description, price, item, lot))
...
def add_katalog(conn, name: str, description: str):
    ...
    c.execute("INSERT INTO katalog (name, description) VALUES (?, ?)",
              (name, description))
...
def edit_position(conn, description: str, name: str):
    ...
    c.execute('UPDATE position SET description = ? WHERE name = ?',
              (description, name,))
...
def add_take_money(conn, take_money, user_id):
    ...
    c.execute('UPDATE users SET take_money = ? WHERE user_id = ?',
              (take_money, user_id,))
...
def update_user_purchase(conn, purchase, user_id):
    ...
    c.execute('UPDATE users SET purchase = ? WHERE user_id = ?',
              (purchase, user_id,))
...
def return_position_5(conn, name_katalog):
    ...
    c.execute(
        "SELECT COUNT(name_katalog) FROM position WHERE name_katalog = ?", (name_katalog,))
...
def add_buyer(conn, id, first_name: str, last_name: str):
    ...
    c.execute("INSERT INTO buyers (id, first_name, last_name) VALUES (?, ?, ?)",
...
def add_sale(conn, user_id, price, date: str):
    ...
    c.execute("INSERT INTO sales (user_id, price, date) VALUES (?, ?, ?)",
              (user_id, price, date))
